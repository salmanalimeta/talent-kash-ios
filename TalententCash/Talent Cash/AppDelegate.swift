...
//    func saveVideoIntoDoca(remoteUrl:String){
//
//        let videoUrl = remoteUrl
//
...
//                                {
//                                        self.saveAndUpdateVideoData(remoteUrl:url.absoluteString, vURL: destinationUrl.absoluteString)
//                                }
//                                else
//                                {
