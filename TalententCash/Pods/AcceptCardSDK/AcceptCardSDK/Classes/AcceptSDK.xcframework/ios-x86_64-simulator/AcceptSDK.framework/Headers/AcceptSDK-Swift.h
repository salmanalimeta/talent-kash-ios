...
#ifndef ACCEPTSDK_SWIFT_H
#define ACCEPTSDK_SWIFT_H
...
typedef SWIFT_ENUM(NSInteger, TZStackViewAlignment, open) {
...
typedef SWIFT_ENUM(NSInteger, TZStackViewDistribution, open) {
